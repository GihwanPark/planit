...
|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| 정유민(팀장) |                                                                                                                                                                                                                                                                                        |       |
| 박기환     | - 팀 CRUD 구현 <br/> - 팀원 초대와 방출, 수락 및 거절 구현<br/> 팀 단위 TodoList CRUD 구현 <br/> - 등록된 팀 Todo를 사용자별로 상태를 관리하는 기능 구현 <br/> - 팀, 팀 단위 TodoList, 사용자 간의 중간 테이블 구축 <br/>- 팀 도메인 테스트 코드 작성 <br/>
- teamList, teamCalander, teamManage 프론트엔드 구현 및 협업                                                                                                                                                                                                                                                                                       |  https://github.com/GihwanPark     |
